...
def list_more():
    urls = [
        "https://gapli.com/api/v1/integrations/marketplace/products?account_id=116&limit=1",
        "https://gapli.com/api/v1/integrations/marketplace/products?account_id=61&limit=1",
    ]
    for url in urls:
        print(f"GET {url}")
